...
//com essa modificação, esta classe será responsável por gerar o extrato do cliente, sendo a responsável 
//pelo processo.
public class ExtratoAlugueis{

	public ExtratoAlugueis(){
	...
	public String extrato(Cliente cliente) {
		...
		Iterator alugueis = cliente.fitasAlugadas.iterator();
		...
		resultado += "O cliente acumulou " + pontosDeAlugadorFrequente + " pontos de alugador frequente";
		return resultado;
	}	
}
